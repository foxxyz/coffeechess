...
(function() {
  var AIPlayer, Bishop, Chess, HumanPlayer, King, Knight, Pawn, Piece, Player, Queen, Rook, em_value, game, pieces,
  ...
  window.Chess = Chess = (function() {
    ...
    Chess.prototype.animate = function(x, y, z) {
      return this.dom.css('-webkit-transform', 'rotateX(' + x + 'deg) rotateY(' + y + 'deg) rotateZ(' + z + 'deg)');
    };
    ...
    Chess.prototype.promote = function(pawn) {
      $(".promotion").show();
      $(".promotion span").on("click", function() {
